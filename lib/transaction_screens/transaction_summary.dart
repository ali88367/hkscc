...
import 'package:hkksccc/transaction_screens/recent_transaction.dart';
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('Choose account to pay from',style: jost400(14.sp, Colors.black),),
            SizedBox(
              height: 19.h,
            ),
            Row(
            ...
            Center(child: CustomButton(text: 'Confirm & Transfer', color: redColor, onPressed: (){
             // Get.to(TranscationList());
              Get.to(RecentTransaction());
            },width: 218.w,))
          ],
        ),
      ),
